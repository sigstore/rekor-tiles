		...
		},
		{
			...
			dsse: &pb.DSSERequestV0_0_2{
				Envelope: &dsse.Envelope{
					...
					Signatures: []*dsse.Signature{
						...
						{
							Sig:   b64DecodeOrDie(t, "MGYCMQDdKEzOCt71AzF+KKxrDQgCcPtsnfPZORmPlFZutXFqM8y/fi77sEAOjYkVdc4xxJwCMQC/4JuQ/bDWQV4QzPRA/u03pG49iTUDskoCFIrmabe0XyC9JkY1yyeuNS2LixMCaCI="),
							Keyid: "",
						},
					},
				},
			...
			expectedEntry: &pb.DSSELogEntryV0_0_2{
				...
				Signatures: []*pb.Signature{
					...
					{
						Content: b64DecodeOrDie(t, "MGYCMQDdKEzOCt71AzF+KKxrDQgCcPtsnfPZORmPlFZutXFqM8y/fi77sEAOjYkVdc4xxJwCMQC/4JuQ/bDWQV4QzPRA/u03pG49iTUDskoCFIrmabe0XyC9JkY1yyeuNS2LixMCaCI="),
						Verifier: &pb.Verifier{
							Verifier: &pb.Verifier_PublicKey{
								PublicKey: &pb.PublicKey{
									RawBytes: []byte(publicKeyP384),
