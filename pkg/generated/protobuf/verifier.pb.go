...
var file_verifier_proto_rawDesc = string([]byte{
	...
	0x08, 0x76, 0x65, 0x72, 0x69, 0x66, 0x69, 0x65, 0x72, 0x42, 0x38, 0x5a, 0x36, 0x67, 0x69, 0x74,
...
var file_verifier_proto_goTypes = []any{
	...
	(v1.PublicKeyDetails)(0),   // 2: dev.sigstore.common.v1.PublicKeyDetails
	(*v1.X509Certificate)(nil), // 3: dev.sigstore.common.v1.X509Certificate
}
var file_verifier_proto_depIdxs = []int32{
	2, // 0: dev.sigstore.rekor.v2.PublicKey.key_details:type_name -> dev.sigstore.common.v1.PublicKeyDetails
	0, // 1: dev.sigstore.rekor.v2.Verifier.publicKey:type_name -> dev.sigstore.rekor.v2.PublicKey
	3, // 2: dev.sigstore.rekor.v2.Verifier.x509_certificate:type_name -> dev.sigstore.common.v1.X509Certificate
