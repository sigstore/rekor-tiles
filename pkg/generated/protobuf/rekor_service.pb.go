...
const file_rekor_v2_rekor_service_proto_rawDesc = "" +
	"\n" +
	"\x1crekor/v2/rekor_service.proto\x12\x15dev.sigstore.rekor.v2\x1a\x1cgoogle/api/annotations.proto\x1a\x19google/api/httpbody.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x14sigstore_rekor.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x14rekor/v2/entry.proto\")\n" +
	"\vTileRequest\x12\f\n" +
	...
	"\rGetCheckpoint\x12\x16.google.protobuf.Empty\x1a\x14.google.api.HttpBody\"\x1a\x82\xd3\xe4\x93\x02\x14\x12\x12/api/v2/checkpointB\xc0\x03\x92A\xbc\x02\x12\xbc\x01\n" +
	"\bRekor v2\"Z\n" +
	"\x10Rekor v2 project\x12'https://github.com/sigstore/rekor-tiles\x1a\x1dsigstore-dev@googlegroups.com*O\n" +
	"\x12Apache License 2.0\x129https://github.com/sigstore/rekor-tiles/blob/main/LICENSE2\x032.0\x1a\x14*.rekor.sigstore.dev*\x01\x012\x10application/json:\x10application/jsonr>\n" +
	"\x13More about Rekor v2\x12'https://github.com/sigstore/rekor-tiles\n" +
	"\x1bdev.sigstore.proto.rekor.v2B\x0eRekorV2ServiceP\x01Z9github.com/sigstore/rekor-tiles/v2/pkg/generated/protobuf\xea\x02\x13Sigstore::Rekor::V2b\x06proto3"
