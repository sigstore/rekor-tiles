...
const file_rekor_v2_entry_proto_rawDesc = "" +
	...
	"apiVersion\x124\n" +
	"\x04spec\x18\x03 \x01(\v2\x1b.dev.sigstore.rekor.v2.SpecB\x03\xe0A\x02R\x04spec\"\xc0\x01\n" +
	"\x04Spec\x12d\n" +
	"\x12hashed_rekord_v002\x18\x01 \x01(\v2/.dev.sigstore.rekor.v2.HashedRekordLogEntryV002B\x03\xe0A\x02H\x00R\x10hashedRekordV002\x12J\n" +
	"\tdsse_v002\x18\x02 \x01(\v2'.dev.sigstore.rekor.v2.DSSELogEntryV002B\x02\x18\x01H\x00R\bdsseV002B\x06\n" +
	"\x04spec\"\xea\x01\n" +
	"\x12CreateEntryRequest\x12r\n" +
	"\x1ahashed_rekord_request_v002\x18\x01 \x01(\v2..dev.sigstore.rekor.v2.HashedRekordRequestV002B\x03\xe0A\x02H\x00R\x17hashedRekordRequestV002\x12X\n" +
	"\x11dsse_request_v002\x18\x02 \x01(\v2&.dev.sigstore.rekor.v2.DSSERequestV002B\x02\x18\x01H\x00R\x0fdsseRequestV002B\x06\n" +
	"\x04specB~\n" +
	"\x1bdev.sigstore.proto.rekor.v2B\fRekorV2EntryP\x01Z9github.com/sigstore/rekor-tiles/v2/pkg/generated/protobuf\xea\x02\x13Sigstore::Rekor::V2b\x06proto3"
