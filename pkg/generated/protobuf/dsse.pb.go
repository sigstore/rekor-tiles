...
type DSSERequestV0_0_2 struct {
	...
	// Signatures and their associated verification material used to verify the payload in the envelope
	// These should be a direct 1:1 mapping with the signatures provided in the envelope
	Signatures    []*SignatureAndVerifier `protobuf:"bytes,2,rep,name=signatures,proto3" json:"signatures,omitempty"`
...
func (x *DSSERequestV0_0_2) GetSignatures() []*SignatureAndVerifier {
	if x != nil {
		return x.Signatures
	}
	return nil
...
type DSSELogEntryV0_0_2 struct {
	...
	Signatures    []*SignatureAndVerifier `protobuf:"bytes,3,rep,name=signatures,proto3" json:"signatures,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *DSSELogEntryV0_0_2) GetSignatures() []*SignatureAndVerifier {
	if x != nil {
		return x.Signatures
	}
	return nil
...
var file_dsse_proto_rawDesc = string([]byte{
	...
	0x69, 0x66, 0x69, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9b, 0x01, 0x0a, 0x11,
	...
	0x6e, 0x76, 0x65, 0x6c, 0x6f, 0x70, 0x65, 0x12, 0x50, 0x0a, 0x0a, 0x73, 0x69, 0x67, 0x6e, 0x61,
	0x74, 0x75, 0x72, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x64, 0x65,
	0x76, 0x2e, 0x73, 0x69, 0x67, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x72, 0x65, 0x6b, 0x6f, 0x72,
	0x2e, 0x76, 0x32, 0x2e, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x41, 0x6e, 0x64,
	0x56, 0x65, 0x72, 0x69, 0x66, 0x69, 0x65, 0x72, 0x42, 0x03, 0xe0, 0x41, 0x02, 0x52, 0x0a, 0x73,
	0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x73, 0x22, 0xb1, 0x01, 0x0a, 0x12, 0x44, 0x53,
	0x53, 0x45, 0x4c, 0x6f, 0x67, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x56, 0x30, 0x5f, 0x30, 0x5f, 0x32,
	...
	0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x48, 0x61, 0x73, 0x68, 0x12, 0x50, 0x0a, 0x0a, 0x73,
	...
	0x65, 0x41, 0x6e, 0x64, 0x56, 0x65, 0x72, 0x69, 0x66, 0x69, 0x65, 0x72, 0x42, 0x03, 0xe0, 0x41,
	0x02, 0x52, 0x0a, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x73, 0x42, 0x38, 0x5a,
...
var file_dsse_proto_depIdxs = []int32{
	...
	3, // 1: dev.sigstore.rekor.v2.DSSERequestV0_0_2.signatures:type_name -> dev.sigstore.rekor.v2.SignatureAndVerifier
	4, // 2: dev.sigstore.rekor.v2.DSSELogEntryV0_0_2.payloadHash:type_name -> dev.sigstore.common.v1.HashOutput
	3, // 3: dev.sigstore.rekor.v2.DSSELogEntryV0_0_2.signatures:type_name -> dev.sigstore.rekor.v2.SignatureAndVerifier
