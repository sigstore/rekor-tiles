...
const file_rekor_v2_dsse_proto_rawDesc = "" +
	"\n" +
	"\x13rekor/v2/dsse.proto\x12\x15dev.sigstore.rekor.v2\x1a\x15sigstore_common.proto\x1a\x0eenvelope.proto\x1a\x17rekor/v2/verifier.proto\"\x8d\x01\n" +
	"\x0fDSSERequestV002\x123\n" +
	"\benvelope\x18\x01 \x01(\v2\x13.io.intoto.EnvelopeB\x02\x18\x01R\benvelope\x12A\n" +
	"\tverifiers\x18\x02 \x03(\v2\x1f.dev.sigstore.rekor.v2.VerifierB\x02\x18\x01R\tverifiers:\x02\x18\x01\"\xa6\x01\n" +
	"\x10DSSELogEntryV002\x12H\n" +
	"\vpayloadHash\x18\x01 \x01(\v2\".dev.sigstore.common.v1.HashOutputB\x02\x18\x01R\vpayloadHash\x12D\n" +
	"\n" +
	"signatures\x18\x02 \x03(\v2 .dev.sigstore.rekor.v2.SignatureB\x02\x18\x01R\n" +
	"signatures:\x02\x18\x01B}\n" +
	"\x1bdev.sigstore.proto.rekor.v2B\vRekorV2DsseP\x01Z9github.com/sigstore/rekor-tiles/v2/pkg/generated/protobuf\xea\x02\x13Sigstore::Rekor::V2b\x06proto3"
